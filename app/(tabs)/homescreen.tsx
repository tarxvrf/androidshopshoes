      ...
      <ScrollView>
        <View style={styleshomescreen.container}>
          ...
          <View style={styleshomescreen.header}>
            ...
            />
            <TextInput
              style={styleshomescreen.inputsearch}
              placeholder="Searchnya"
              focusable={true}
          ...
          <View style={{ flex: 1, paddingHorizontal: 20, gap: 20 }}>
            ...
            <View style={{ insetBlockEnd: 50, gap: 10, marginBottom: 10 }}>
              ...
              <Cardimagetop
                ...
                onPress={handlepres}
                judul="ini judulnya"
                subjudul="loeremdfadfafjdafjaksfjkadsjfdkadsdjfkasdfjkdasfjkadsfjkasdfjajsfkakjfasfkafk"
              />
            </View>
